...
def main(
    ...
    humanoid_mjcf_path: Optional[str] = "/home/nathan/IsaacGym_Preview_4_Package/PBHC/description/robots/g1/smpl_humanoid.xml",
    ...
    if root_files_to_process:
        ...
        for filename in tqdm(root_files_to_process):
            ...
            import joblib
            smpl_parser_n = SMPL_Parser(model_path="/home/nathan/IsaacGym_Preview_4_Package/PBHC/smpl_retarget/smpl_model/smpl", gender="neutral")
            print("smpl_parser_n: ", smpl_parser_n)
            shape_new, scale = joblib.load(f"/home/nathan/IsaacGym_Preview_4_Package/PBHC/smpl_retarget/mink_retarget/shape_optimized_neutral.pkl")
